...
exports.createOrdonnance = catchAsync(async (req, res, next) => {
    ...
    const { patient_id, dossier_id, consultation_id, service_id, ...ordonnanceData } = req.body;
...
exports.createDemandeExamen = catchAsync(async (req, res, next) => {
    ...
    const { patient_id, dossier_id, consultation_id, service_id, ...demandeData } = req.body;
...
exports.getPrescriptionsByPatient = catchAsync(async (req, res, next) => {
    ...
    const prescriptions = await prescriptionService.getPrescriptionsByPatient(patient_id, filters, includeArray);
...
exports.getPrescriptionById = catchAsync(async (req, res, next) => {
    ...
    const prescription = await prescriptionService.getPrescriptionById(id, includeArray);
